          ...
          <div class="io">
            <div class="container">
              <div class="row justify-content-md-start">
                <div class="col-md-12">
                  <h4>Lista de Personajes almacenados por usuario</h4> <?php
                  ...
                  <h4>Archivos almacenados por usuario</h4> <?php
                  ...
                  dirToOptions();
                  echo "</ol>";
                         ?> <h4>Registro de todos los personajes creados en total </h4> <?php
                  include "../php/config.php";
                  ...
                  ?> <table class="table table-hover">
                    ...
                    $count = mysqli_num_rows($result);
                    if ($count != 0) {
                        while ($row = mysqli_fetch_array($result)) { ?> <tr class='character'>
                        <td> <?php echo $row["asociadoa"]; ?> </td>
                        <td> <?php echo $row["nombre"]; ?> </td>
                        <td> <?php echo $row["clase"]; ?> </td>
                        <td> <?php echo $row["raza"]; ?> </td>
                        <td> <?php echo $row["nivel"]; ?> </td>
                        <td> <?php echo $row["fecha"]; ?> </td> <?php }
                    }
                    ?>
                      </tr>
                    </tbody>
              ...
              <div class="col-md-12">
                <h4>Usuarios registrados</h4> <?php
                               include "../php/config.php";
                  ...
                  <tbody> 
                    <?php
                      $count = mysqli_num_rows($result);
                           if ($count != 0) {
                              while ($row = mysqli_fetch_array($result)) { ?> <tr class='usuario'>
                      <td> <?php echo $row["nick"]; ?> </td>
                      <td> 
                        <a value="borrar" type="button"  href="../php/userDeletion.php?id=<?php echo $row["id"]; ?>" 
                        style='cursor: pointer;color: red;'>Borrar</a>
