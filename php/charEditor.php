...
<body id="website">
    ...
    <div class="row-cols-auto">
      <div id="divisor">
        ...
        <div class="io">
          ...
          <form action="charEdition.php" method="post" id="PJeditor"><!-- inicio de formulario -->
            <div class="container col-md-12">
              <div class="row justify-content-md-start">
                ...
                include("config.php");
                $id = $_GET['id'];
                /* sql para seleccionar personaje de la tabla a traves de la id */
                ...
                if ($count != 0) {
                  while ($row = mysqli_fetch_array($result)) {
                    ?>
                    <div class="col-md-12"><!-- campos del formulario -->
                      ...
                      RACE &nbsp; <input name="raza" id="raza" style="width:200px" type="text"
                        value="<?php echo $row['raza'] ?>">
                      <br>
                      <br> ARMOR CLASS &nbsp; <input name="armorClass" id="armorClass" style="width:70px" type="number"
                        value="<?php echo $row['armorClass'] ?>">
                      ...
                      CURRENT HIT POINTS&nbsp; <input name="hitPoints" id="hitPoints" style="width:60px" type="number"
                        value="<?php echo $row['hitPoints'] ?>">
                      HIT DICE&nbsp; <input name="hitDice" id="hitDice" style="width:100px" type="text"
                        value="<?php echo $row['hitDice'] ?>">
                      SPEED&nbsp; <input name="speed" id="speed" style="width:100px" type="number"
                        value="<?php echo $row['speed'] ?>">
                      <input style="display:none" ; name="id" id="id" style="width:60px" type="number"
                        value="<?php echo $row['id'] ?>">
                      <hr>
                      <h5>INVENTORY AND/OR EQUIPMENT</h5>
                      <div class="col-md-12"><textarea style="width:100%" name="invent"
                          id="invent"><?php echo $row['invent'] ?></textarea></div>
                      <h5> SPELLS </h5>
                      <div class="col-md-12"><textarea style="width:100%" name="spells"
                          id="spells"><?php echo $row['spells'] ?></textarea></div>
                    </div>
                    <?php
                  }
                }
  ...
  <div>
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
      <ol class="breadcrumb"> <!-- breadcrums pequeña guia decorativa indica en que punto de la web nos encontramos-->
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body" style="font-size:20px">
          <p> En este lugar podras crear y guardar tus personajes. <br> Dentro de este espacio tendras que rellenar
            todos los campos que sean necesarios para tu personaje de campaña, o si estas experimentando creando otros
            aventureros por diversion, o simplemente quieres probar este apartado. </p>
          <p> No olvides que en esta web en el apartado de herramientas en el primer acordeon en 'Todo para tu PJ', como
            en la parte superior dispones de los enlaces de la "wikipedia" de dnd, la calculadora de puntos, el
            generador de nombre (si no tienes uno pensado). </p>
          <p>En la vista de tu cuenta, podras editar de vuelta tu personaje tanto si te olvidaste de algo, si estas
            jugando o quieres corregir algun detalle.</p>
          <p> No te preocupes y tomate tu tiempo para encontrar a tu aventurero deseado. </p>
        </div>
        <div class="modal-footer" style="font-size:18px">
          <p style="color:rgb(235, 160, 86); font-size:14px;">Haz click en aceptar una vez hayas leido y entendido el
            texto</p>
